  ...
  return (
    <div className="container App">
      <div className="text">
        ...
        компонентов. Но реализовать это через код для меня оказалось непосильным. Поэтому обращался
        за помощью к <span className="span_text">Валерии Куликовой</span> Удаление дня недели
        работает через наведение на блок с днем недели
      </div>
